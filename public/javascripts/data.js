...
questions2 = [
    { question: "Dans un second temps, pour chaque affirmation, cochez selon si vous êtes plutôt « 1 - Totalement en désaccord » ou « 7 - Totalement en accord ».", type: "info" },
    { question: "Les cases intermédiaires servent à nuancer votre réponse.", type: "info" },
...
let roundsInfos = [
    {
        round: 0,
        name: 'Ceci est une <b>manche test</b> pour vous familiariser avec le jeu. Ci-dessous, vous pouvez voir les choix possibles et leurs conséquences. Imaginons, ici, que vous recevez 100€. Vous pouvez garder cet argent ou le verser à la coopérative (<b>ce premier choix n\'aura pas de conséquences sur les scores</b>). Ensuite, plus bas, <b>vous avez reçu aléatoirement des outils à collectionner</b> (sans conséquences sur les scores). Vous pouvez distribuer vos doubles ou non aux autres joueurs. Vous pourrez peut-être en recevoir d\' autres joueurs. Enfin, vous pouvez avoir <b>accès au classement tout en bas de l\'écran.</b>',
        A: { text: 'Vous recevez 100€', personalScore: 0, teamScore: 0 },
        B: { text: 'Votre coopérative reçoit 100€', personalScore: 0, teamScore: 0 },
    },
    {
        round: 1,
        name: '<b>C\'est maintenant que le jeu commence</b>, votre coopérative est actuellement en 3ème position. Elle procède à un appel au don : vous pouvez choisir de partager vos derniers revenus, ou de les garder pour vous.',
    ...
    },
    {
        ...
        C: { text: 'Vous perdez 700€, mais votre coopérative reçoit 1400€', personalScore: -700, teamScore: 1400 },
    ...
    {
        round: 10,
        name: 'Un investissement vous rapporte de l\'argent. Vous pouvez encaisser les gains tel quel, ou les doubler en demandant une participation à la coopérative.',
        A: { text: 'Vous recevez 450€', personalScore: 450, teamScore: 0 },
        D: { text: 'Vous recevez 900€, mais votre coopérative perd 450€', personalScore: 900, teamScore: -450 },
    },
    {
        round: 11,
        gainCollectible: 8,
        name: 'Un projet rentable se présente : soit vous investissez un peu maintenant pour faire prospérer la coopérative, soit vous demandez à la coopérative d\'investir dans votre entreprise.',
        C: { text: 'Vous perdez 550€, mais votre coopérative reçoit 1100€', personalScore: -550, teamScore: 1100 },
        D: { text: 'Vous recevez 1100€, mais votre coopérative perd 550€', personalScore: 1100, teamScore: -550 },
    },
    {
        round: 12,
        name: 'Un investissement risqué pourrait rapporter gros. Vous préférez jouer la sécurité et récupérer un petit gain ; ou bien vous investissez pour faire grandir la coopérative ; ou encore vous investissez l\'argent de la coopérative pour bénéficier d\'un gain important. ',
        A: { text: 'Vous recevez 300€', personalScore: 300, teamScore: 0 },
        C: { text: 'Vous perdez 300€, mais votre coopérative reçoit 600€', personalScore: -300, teamScore: 600 },
        D: { text: 'Vous recevez 600€, mais votre coopérative perd 300€', personalScore: 600, teamScore: -300 },
    },
